...
#[Route('/pdfProduct', name: 'app_pdfProduct')]
    ...
    public function search(Request $request , ProductRepository $cr ,SerializerInterface $serializer): JsonResponse
    {
        ...
        $json=$serializer->serialize($resultss,'json',['groups'=>'product_list']);
    ...
    //#[Route('/recherche/by-libelle')]
    // #[Route('/recherche/by-libelle', name: 'rechercheProd')]
    // public function rechercheParSociete(Request $request, ProductRepository $productRepository): Response
    // {
    //     $searchValue = $request->get('search-value');
    //     if ($searchValue != null) {
    //         $products = $productRepository->findProductByLibelle($searchValue);
