...
class ReservationController extends AbstractController
{
 ...
 #[Route('/addReservation', name: 'app_addReservation')]
    ...
    public function addReservationJSON(ManagerRegistry $doctrine,Request $request,SerializerInterface $serializer,ProductRepository $repository,UserRepository $UserRepository,MailerInterface $mailer)
    {
