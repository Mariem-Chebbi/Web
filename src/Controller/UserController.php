...
class UserController extends AbstractController
{
  ...
  public function updatP(ManagerRegistry $doctrine,$id,UserRepository $repository,Request $request)
    ...
    public function listSearch(UserRepository $repo)
    {
        $users = $repo->findAll();
    ...
    /* 
    #[Route('/rdv/search/{email}', name: 'app_search')]
    public function indexSearch(Request $request, UserRepository $repo,string $email)
    {
        $searchValue = $request->get('search-value');
        if ($searchValue != null) {
            $users = $userRepository->findUserByEmail($searchValue);
