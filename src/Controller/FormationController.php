...
// #[Route('/formation/search', name: 'app_search')]
// public function indexSearch(FormationRepository $repo)
// {
//     $client=$this->getUser();
...
#[Route('/formation/search/{Libelle}', name: 'app_formation_search')]
public function search(FormationRepository $repo, $Libelle): JsonResponse
{
    
    $formations = $repo->searchByLibelle($Libelle);
    $results = [];
    ...
    foreach ($formations as $formation) {
        $results[] = [
            ...
            'date' => $formation->getDateFormation(),
