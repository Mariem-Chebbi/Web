 ...
 */
final class Version20230215140111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE personnel (id INT AUTO_INCREMENT NOT NULL, id_centre_id INT DEFAULT NULL, cin VARCHAR(255) NOT NULL, Type_personnel VARCHAR(255) NOT NULL, INDEX IDX_A6BCF3DEC6096BE4 (id_centre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
