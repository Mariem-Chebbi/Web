 ...
 */
final class Version20230305130328 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog DROP categorie_id, CHANGE image image VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE blog ADD categorie_id INT DEFAULT NULL, CHANGE image image VARCHAR(255) NOT NULL');
